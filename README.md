...
Веб-приложение для автоматического форматирования документов Word (.docx) в соответствии с требованиями ГОСТ с использованием AI-анализа структуры документа. Поддерживает различные типы работ: ВКР, дипломы, курсовые работы и другие.

## Возможности

- **Модульная система шаблонов**:
  - ВКР (выпускные квалификационные работы) по ГОСТ 7.32-2017
  - Курсовые работы (упрощенный вариант ГОСТ)
...
- **AI-анализ структуры документа** с поддержкой нескольких провайдеров:
  ...
  - Подробнее: [LOCAL_MODELS.md](LOCAL_MODELS.md)

- **Автоматическое форматирование** согласно выбранному шаблону:
  - Шрифт Times New Roman 14pt
  - Полуторный межстрочный интервал
  - Поля документа по стандарту
  - Выравнивание по ширине с отступом абзаца
...
- **Выбор шаблона** при загрузке документа
